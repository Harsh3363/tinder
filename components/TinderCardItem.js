...
// *************************************** below we are using a npm package -> react-tinder-card which will let us do right and left swapping
...
//   nothing will happen if we drag card up or down
  preventSwipe={['up','down']}
//   function which will run on swipe ->
  onSwipe={onSwipe}
  >
    ...
    >
        ...
        {/* gonna contain the wallet address of the user */}
        <div className={style.walletAddress} >
        {card.walletAddress.slice(0, 6)}...{card.walletAddress.slice(39)}
        </div>
        {/* going to contain all the reactions present for a person */}
        <div className={style.reactionsContainer}>

            {/* this when clicked will trigger a go back function */}
